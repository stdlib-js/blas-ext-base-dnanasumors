...
```javascript
dnanasumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnanasumors@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dnanasumors/tags). For example,

```javascript
dnanasumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnanasumors@v0.3.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanasumors = require( 'path/to/vendor/umd/blas-ext-base-dnanasumors/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnanasumors@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/actions/workflows/test.yml?query=branch:v0.3.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dnanasumors.svg
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dnanasumors/blob/main/branches.md
